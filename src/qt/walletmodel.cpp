...
static void NotifyzSPDZReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzSPDZReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzSPDZReset.connect(boost::bind(NotifyzSPDZReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzSPDZReset.disconnect(boost::bind(NotifyzSPDZReset, this));
