...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zSPDZTracker->HasMintTx(hash))) {
            //zSPDZ stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZSPDZ;
...
bool IsZSPDZType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZSPDZ:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZSPDZ || type == TransactionRecord::MNReward) {
