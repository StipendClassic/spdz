                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zSPDZ || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending SPDZ because you wouldn't check it anyway.
    if (context == Context::Send_SPDZ || context == Context::Send_zSPDZ) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR SPDZ</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
