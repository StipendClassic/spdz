...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"SPDZaddress\"\n"
            "\nReturn information about the given SPDZ address.\n"

            "\nArguments:\n"
            "1. \"SPDZaddress\"     (string, required) The SPDZ address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"SPDZaddress\", (string) The SPDZ address validated\n"
