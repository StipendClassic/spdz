...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0411e9cb06c2b76fd67f2824dba85867d7e76796a1f89d8bec0a35a3bedaad9602a22c6fe523c4f3c3d89efb4b8d721685141dab32f212711b99d829e23b0cef0e");
        nDefaultPort = 61472;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // SPDZ starting difficulty is 1 / 2^12
        ...
        nTargetSpacing = 2 * 75;  // SPDZ: 150 Seconds
        nMaturity = 100;
        ...
        nZerocoinStartTime = 1627749759; // October 17, 2017 4:30:00 AM
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Stipend is forked by skilled developers";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043cf59a3f2479ebce45f43d4d2f39873972fec215a424f0aabf36b34e94232697b9cbf623c96f02cf7aee4ec9f7b1562a9e95e6e864d3fe11efc222ccad667cc6") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1527749759;
        ...
        nStartMasternodePayments = 1500; //At Block 1500
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zSPDZ to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("043cf59a3f2479ebce45f43d4d2f39873972fec215a424f0aabf36b34e94232697b9cbf623c96f02cf7aee4ec9f7b1562a9e95e6e864d3fe11efc222ccad667cc6");
        nDefaultPort = 51474;
        ...
        nStartMasternodePayments = 1500; //Fri, 09 Jan 2015 21:05:58 GMT
