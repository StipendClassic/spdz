...
---------------------
The stake miner code now filters out zSPDZ double spends that were on rare occasions being slipped into blocks (and being rejected by peers when broadcast to the network).
...
More Extensive Display of zSPDZ Confirmation/Maturity Status
---------------------
Within the Privacy Dialog of the QT wallet, the _Zerocoin Stats_ section now displays both the confirmation and maturity status of minted zSPDZ's. Previously this was only able to be viewed within the zSPDZ Control dialog. The main Overview tab of the QT wallet now splits zSPDZ balance into subcategories: _Unconfirmed_, _Immature_, and _Mature_.
